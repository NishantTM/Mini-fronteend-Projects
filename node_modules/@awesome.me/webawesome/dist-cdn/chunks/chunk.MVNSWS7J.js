...
var WaPopup = class extends WebAwesomeElement {
  ...
  reposition() {
    ...
    const getOffsetParent2 = this.SUPPORTS_POPOVER ? (element) => platform.getOffsetParent(element, e3) : platform.getOffsetParent;
...
__decorateClass([
  n({ attribute: false, type: Boolean })
