...
} from "./chunk.LAIHMICP.js";
import {
  activeElements
} from "./chunk.TTJR7FH2.js";
import {
  submitOnEnter
...
var WaSlider = class extends WebAwesomeFormAssociatedElement {
  ...
  static get validators() {
    return o ? [] : [...super.validators, SliderValidator()];
  }
  ...
  render() {
    ...
    const markersTemplate = this.withMarkers ? x`
          <div id="markers" part="markers">
            ${markers.map(
      (marker) => x`<span part="marker" class="marker" style=${o2({ "--position": `${marker}%` })}></span>`
    )}
          </div>
        ` : "";
      ...
      return x`
        ...
        "--end": `${Math.max(minThumbPosition, maxThumbPosition)}%`
            ...
            <span
              ...
              style=${o2({ "--position": `${minThumbPosition}%` })}
              role="slider"
            ...
            <span
              ...
              style=${o2({ "--position": `${maxThumbPosition}%` })}
              role="slider"
              aria-valuemin=${this.min}
        ...
        >
          <div id="track" part="track">
            <div
              id="indicator"
              part="indicator"
              style=${o2({ "--start": `${indicatorOffsetPosition}%`, "--end": `${thumbPosition}%` })}
            ></div>

            ${markersTemplate}
            <span id="thumb" part="thumb" style=${o2({ "--position": `${thumbPosition}%` })}></span>
          </div>
